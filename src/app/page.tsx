...
export default function HomePage() {
  ...
  return (
    <>
      ...
      {/* WhatsApp Group */}
      <section className="bg-[#941424]">
        <div className="max-w-7xl mx-auto px-4 py-8 md:py-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="text-center md:text-left">
              <h2 className="text-white text-xl md:text-2xl font-bold">Join our WhatsApp Group 🎉</h2>
              <p className="text-white/80 text-sm mt-1">Get exclusive offers, new arrivals & festive updates first!</p>
            </div>
            <a
              href="https://chat.whatsapp.com/1wVIawvKnRA9qY79GXTOpg?s=cl&p=a&mlu=1&amv=1"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-[#25D366] hover:bg-[#1DA851] text-white font-semibold px-6 py-3 rounded-xl transition-all shadow-lg whitespace-nowrap text-sm"
